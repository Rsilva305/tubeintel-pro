  ...
  return (
    ...
    >
      ...
      {!collapsed && subscriptionTier !== 'pro-plus' && (
        <Link 
          href="/subscription" 
          className="mt-4 mx-3 flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white text-sm font-medium py-2 px-3 rounded-lg transition-colors"
        >
          <FaCrown size={14} />
