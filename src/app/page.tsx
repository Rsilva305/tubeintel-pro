      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-12 flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-12 md:mb-0">
            ...
            <p className="text-[#9CA3AF] mb-8 max-w-md text-lg">
              TubeIntel Pro's advanced analytics dashboard helps creators identify trends, track performance metrics, and optimize content strategies to grow your channel faster than ever before.
            </p>
            
            <button 
              className="flex items-center bg-white text-black px-6 py-3 rounded-full font-medium hover:bg-gray-100 transition-colors"
        ...
        <div className="w-full bg-[#121212] py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-400 mb-8 text-lg">Join creators who are growing their YouTube channels with TubeIntel Pro.</p>
            <button 
              onClick={() => router.push('/signup')}
