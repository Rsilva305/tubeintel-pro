        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="flex flex-col space-y-4">
              <Link 
                href="/login"
                className="w-full bg-indigo-100 text-indigo-700 text-center py-2 px-4 rounded-md font-medium"
              >
                Return to Login
              </Link>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Already have an account? <Link href="/login" className="text-indigo-600 hover:text-indigo-800">Log in</Link>
            </p>
          </div>
        </div>
